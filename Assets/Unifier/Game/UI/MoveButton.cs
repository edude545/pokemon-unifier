...
namespace Assets.Unifier.Game.UI {
    ...
    internal class MoveButton : MonoBehaviour {
        ...
        public void UpdateVisuals(BattleSystem.Battler battler) {
            ...
            CategoryIcon.sprite = BundleLoader.LoadAssetWithSubAssets<Sprite>("essentials", "category")[(int)move.Category];
            TypeIcon.sprite = BundleLoader.LoadAssetWithSubAssets<Sprite>("essentials", "types")[move.Type.ID];
        }
