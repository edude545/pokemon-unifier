...
class Interpreter
  ...
  def command_end
   ...
   # for 
    if @main && @event_id > 0 && !($game_map.events[@event_id] && $game_map.events[@event_id].name=="Dependent") #!$game_switches[262]
      # Unlock event
    #  Kernel.pbMessage
