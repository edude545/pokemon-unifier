...
# * Contact
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#  Glitchfinder, the author of this script, may be contacted through her
...
#    4. If you wish to translate this script, please contact Glitchfinder. She
...
#    6. Glitchfinder remains the sole owner of this code. She may modify or
#       revoke this license at any time, for any reason.
#    7. Any code derived from code within this script is owned by Glitchfinder,
#       and you must have her permission to publish, host, or distribute her
#       code.
