class PokemonTemp
  attr_accessor :pokemonMoveData # :nodoc:

  def pbOpenMoveData # :nodoc:
...
class PBMove
 ...
 # attr_accessor(:basedamage) # Gets the number of PP Ups used for this move.
