...
#  end
  ...
  #def move_type_custom
    #return move_type_custom2 if $game_switches[136]
   # return move_type_custom1 if !$game_switches[136]
  #end
 # alias zer0_recalculate_paths_move move_type_custom2
=begin
  def move_type_custom2
    if $game_map.recalculate_paths
      ...
      while @move_route_index < @move_route.list.size
        ...
        if command.code == 0
          ...
          unless @move_route.repeat
            ...
            if @move_route_forcing and not @move_route.repeat
              ...
              return if !@paths || !@paths.is_a?(Array)
              if @paths[0] != nil
        ...
        if command.code <= 14
          ...
          if !@move_route.skippable && !moving? && !jumping? && @paths && @paths.is_a?(Array)
