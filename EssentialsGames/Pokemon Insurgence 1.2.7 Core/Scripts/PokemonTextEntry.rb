...
class PokemonEntry
  ...
  def pbStartScreen(helptext,minlength,maxlength,initialText)
    @scene.pbStartScene(helptext,minlength,maxlength,initialText)
    ret=@scene.pbEntry
    @scene.pbEndScene
    return ret
  end
...
class Interpreter
  def command_303
    if $Trainer
       $Trainer.name=pbEnterText(_INTL("Your name?"),1,
