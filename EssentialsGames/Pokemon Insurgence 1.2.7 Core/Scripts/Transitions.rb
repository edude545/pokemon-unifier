...
#          Kernel.registerMobile("-GMTransitions1-")

    (update_KGC_SpecialTransition rescue nil)
=begin
...
=end
    #      Kernel.registerMobile("-GMTransitions1.2-")

    if @@transition && !@@transition.disposed?
      @@transition.update
    end
     #         Kernel.registerMobile("-GMTransitions1.4-")

    if @@transition && @@transition.disposed? 
      @@transition=nil
    end
#              Kernel.registerMobile("-GMTransitions2-")
